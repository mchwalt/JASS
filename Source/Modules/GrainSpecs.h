...
namespace Modules
{
    inline ModuleSpec grain()
    {
        ...
        m.params = {
            ...
            { "grainPos",     "Position", "POS",   ParamSpec::Kind::Float, juce::NormalisableRange<float> (0.0f, 1.0f, 0.001f), 0.0f, {}, {}, LFOTarget::GrainPosition },
            ...
            { "grainSize",    "Size",     "SIZE",  ParamSpec::Kind::Float, juce::NormalisableRange<float> (5.0f, 300.0f, 0.1f, 0.4f), 60.0f, {}, {}, LFOTarget::GrainSize },
            ...
            { "grainPitch",   "Pitch",    "PITCH", ParamSpec::Kind::Float, juce::NormalisableRange<float> (0.0f, 24.0f, 1.0f), 0.0f, {}, {}, LFOTarget::GrainPitch },   // ring: the CENTRE target
