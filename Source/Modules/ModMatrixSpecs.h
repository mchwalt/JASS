...
namespace Modules
{
    inline ModuleSpec modMatrix()
    {
        ...
        const juce::StringArray tgt { "Off", "Pitch", "Amplitude", "Cutoff", "WT Pos", "Vowel", "Resonance", "Wavefold",   // == LFOTarget (append-only)
                                      "Delay Time", "Delay Mix", "Reverb Mix", "Chorus Depth",
                                      "Dist Drive", "Bitcrush", "Sub Level", "Detune" };
