...
- **AMP** (neben KIT) — wie laut das ganze Kit gegen den Rest steht. Mitte = das Kit wie aufgenommen, rechts davon wird verstärkt (ein Schlagzeug ist mit Reserve ausgesteuert, Oszillatoren sind es nicht).
- **NOTE 1…4** — welches Instrument die Spur spielt. Die Anzeige nennt es beim Namen (Kick, Snare, HH Closed).
- **AMP 1…4** — Balance der Spuren untereinander. **PAN 1…4** platziert jede einzeln.
- **SYNC / RATE / LEN** — Schrittlänge als Notenwert (oder frei), und nach wie vielen Schritten das Muster wiederholt. LEN 16 auf 1/8 sind zwei Takte.
